...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/report02a.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/report02a.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/report02a.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/report02a.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/report02a.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/report02a.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/report02a.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/report02a.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/d49cff7ab1bb/test/src/report02a.lua">d49cff7ab1bb</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/report02a.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">local i = get()</span><a href="#l1"></a>
<span id="l2">if i == &quot;one&quot; then</span><a href="#l2"></a>
<span id="l3">  if check1() then</span><a href="#l3"></a>
<span id="l4">    do1()</span><a href="#l4"></a>
<span id="l5">  end</span><a href="#l5"></a>
<span id="l6">elseif i == &quot;two&quot; then</span><a href="#l6"></a>
<span id="l7">  if check2() then</span><a href="#l7"></a>
<span id="l8">    do2()</span><a href="#l8"></a>
<span id="l9">  else</span><a href="#l9"></a>
<span id="l10">    -- do nothing</span><a href="#l10"></a>
