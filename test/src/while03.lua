...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/while03.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/while03.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/while03.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/while03.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/while03.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/while03.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/while03.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/while03.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/3df19f70471a/test/src/while03.lua">3df19f70471a</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/while03.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if elseredirect then</span><a href="#l1"></a>
<span id="l2">  if inner then</span><a href="#l2"></a>
<span id="l3">    local x = 1</span><a href="#l3"></a>
<span id="l4">    while call(a or b) do</span><a href="#l4"></a>
<span id="l5">      print(x)</span><a href="#l5"></a>
<span id="l6">      x = x + 1</span><a href="#l6"></a>
<span id="l7">    end</span><a href="#l7"></a>
<span id="l8">  end</span><a href="#l8"></a>
<span id="l9">else</span><a href="#l9"></a>
<span id="l10">  print(&quot;else&quot;)</span><a href="#l10"></a>
