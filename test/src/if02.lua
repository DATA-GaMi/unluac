...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/if02.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/if02.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/if02.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/if02.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/if02.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/if02.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/if02.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/if02.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/eaa34da40eeb/test/src/if02.lua">eaa34da40eeb</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/if02.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if a then</span><a href="#l1"></a>
<span id="l2">  for _, v in ipairs(mylist) do</span><a href="#l2"></a>
<span id="l3">    print(v)</span><a href="#l3"></a>
<span id="l4">  end</span><a href="#l4"></a>
<span id="l5">  if b then</span><a href="#l5"></a>
<span id="l6">    print(&quot;done&quot;)</span><a href="#l6"></a>
