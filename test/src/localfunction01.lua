...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/localfunction01.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/localfunction01.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/localfunction01.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/localfunction01.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/localfunction01.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/localfunction01.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/localfunction01.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/localfunction01.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/741754f29ff3/test/src/localfunction01.lua">741754f29ff3</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/localfunction01.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">local function factorial(n)</span><a href="#l1"></a>
<span id="l2">  if n == 0 then</span><a href="#l2"></a>
<span id="l3">    return 1</span><a href="#l3"></a>
<span id="l4">  else</span><a href="#l4"></a>
<span id="l5">    return factorial(n - 1) * n</span><a href="#l5"></a>
<span id="l6">  end</span><a href="#l6"></a>
<span id="l7">end</span><a href="#l7"></a>
<span id="l8">print(factorial(10))</span><a href="#l8"></a>
</pre>
</div>
