...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/if07.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/if07.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/if07.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/if07.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/if07.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/if07.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/if07.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/if07.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/9b5443921cbe/test/src/if07.lua">9b5443921cbe</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/if07.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">return function( self )</span><a href="#l1"></a>
<span id="l2">  local x = 0</span><a href="#l2"></a>
<span id="l3">  local z = false</span><a href="#l3"></a>
<span id="l4">  if a then</span><a href="#l4"></a>
<span id="l5">    if x == 1 then</span><a href="#l5"></a>
<span id="l6">      self.y = &quot;1&quot;</span><a href="#l6"></a>
<span id="l7">    elseif math.random(100) &lt;= self.x then</span><a href="#l7"></a>
<span id="l8">      self.y = &quot;2&quot;</span><a href="#l8"></a>
<span id="l9">    end</span><a href="#l9"></a>
<span id="l10">  end</span><a href="#l10"></a>
<span id="l11">  z = false</span><a href="#l11"></a>
<span id="l12">  return self.y</span><a href="#l12"></a>
