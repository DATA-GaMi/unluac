...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/compareorder06.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/compareorder06.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/compareorder06.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/compareorder06.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/compareorder06.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/compareorder06.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/compareorder06.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/compareorder06.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/bf56993a8519/test/src/compareorder06.lua">bf56993a8519</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/compareorder06.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if f1() == &quot;a&quot; then</span><a href="#l1"></a>
<span id="l2">  g()</span><a href="#l2"></a>
<span id="l3">end</span><a href="#l3"></a>
<span id="l4">if &quot;b&quot; == f2() then</span><a href="#l4"></a>
<span id="l5">  g()</span><a href="#l5"></a>
<span id="l6">end</span><a href="#l6"></a>
<span id="l7">if f3() ~= &quot;c&quot; then</span><a href="#l7"></a>
<span id="l8">  g()</span><a href="#l8"></a>
<span id="l9">end</span><a href="#l9"></a>
<span id="l10">if &quot;d&quot; ~= f4() then</span><a href="#l10"></a>
<span id="l11">  g()</span><a href="#l11"></a>
