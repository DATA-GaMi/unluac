...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/break13.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/break13.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/break13.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/break13.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/break13.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/break13.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/break13.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/break13.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/11c35ba1edd0/test/src/break13.lua">11c35ba1edd0</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/break13.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">while true do</span><a href="#l1"></a>
<span id="l2">  if a then</span><a href="#l2"></a>
<span id="l3">    if b then</span><a href="#l3"></a>
<span id="l4">      print(&quot;ab&quot;)</span><a href="#l4"></a>
<span id="l5">    end</span><a href="#l5"></a>
<span id="l6">    if c then</span><a href="#l6"></a>
<span id="l7">      if d then</span><a href="#l7"></a>
<span id="l8">        print(&quot;acd&quot;)</span><a href="#l8"></a>
<span id="l9">      end</span><a href="#l9"></a>
<span id="l10">      break</span><a href="#l10"></a>
<span id="l11">    end</span><a href="#l11"></a>
<span id="l12">    print(&quot;guard&quot;)</span><a href="#l12"></a>
<span id="l13">    if e then</span><a href="#l13"></a>
<span id="l14">      print(&quot;ae&quot;)</span><a href="#l14"></a>
<span id="l15">    end</span><a href="#l15"></a>
<span id="l16">  else</span><a href="#l16"></a>
<span id="l17">    print(&quot;~a&quot;)</span><a href="#l17"></a>
