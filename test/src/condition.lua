...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/condition.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/condition.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/condition.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/condition.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/condition.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/condition.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/condition.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/condition.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/741754f29ff3/test/src/condition.lua">741754f29ff3</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/condition.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if a == b and c == d then</span><a href="#l1"></a>
<span id="l2">  f()</span><a href="#l2"></a>
<span id="l3">end</span><a href="#l3"></a>
<span id="l4">if a == b or c == d then</span><a href="#l4"></a>
<span id="l5">  f()</span><a href="#l5"></a>
<span id="l6">end</span><a href="#l6"></a>
<span id="l7">if a &lt; b then</span><a href="#l7"></a>
<span id="l8">  f()</span><a href="#l8"></a>
<span id="l9">end</span><a href="#l9"></a>
<span id="l10">if a &lt;= b then</span><a href="#l10"></a>
<span id="l11">  f()</span><a href="#l11"></a>
<span id="l12">end</span><a href="#l12"></a>
<span id="l13">if not a then</span><a href="#l13"></a>
