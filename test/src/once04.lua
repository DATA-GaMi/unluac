...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/once04.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/once04.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/once04.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/once04.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/once04.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/once04.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/once04.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/once04.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/fd5d2c913ca3/test/src/once04.lua">fd5d2c913ca3</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/once04.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1"></span><a href="#l1"></a>
<span id="l2">for i = 1, 10 do</span><a href="#l2"></a>
<span id="l3">  local t = false</span><a href="#l3"></a>
<span id="l4">  repeat</span><a href="#l4"></a>
<span id="l5">    t = f3(i)</span><a href="#l5"></a>
<span id="l6">    if f4() then</span><a href="#l6"></a>
<span id="l7">      break</span><a href="#l7"></a>
<span id="l8">    else</span><a href="#l8"></a>
<span id="l9">      f1()</span><a href="#l9"></a>
<span id="l10">    end</span><a href="#l10"></a>
<span id="l11">    f2()</span><a href="#l11"></a>
<span id="l12">  until true</span><a href="#l12"></a>
<span id="l13">  if t then</span><a href="#l13"></a>
