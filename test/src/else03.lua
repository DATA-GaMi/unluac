...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/else03.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/else03.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/else03.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/else03.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/else03.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/else03.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/else03.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/else03.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/b2edb27de4be/test/src/else03.lua">b2edb27de4be</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/else03.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if x then</span><a href="#l1"></a>
<span id="l2">  print(&quot;guard&quot;)</span><a href="#l2"></a>
<span id="l3">  if y then</span><a href="#l3"></a>
<span id="l4">    if z then</span><a href="#l4"></a>
<span id="l5">      print(&quot;z&quot;)</span><a href="#l5"></a>
<span id="l6">    else</span><a href="#l6"></a>
<span id="l7">      print(&quot;not z&quot;)</span><a href="#l7"></a>
<span id="l8">    end</span><a href="#l8"></a>
<span id="l9">  end</span><a href="#l9"></a>
<span id="l10">elseif a then</span><a href="#l10"></a>
<span id="l11">  print(&quot;a&quot;)</span><a href="#l11"></a>
