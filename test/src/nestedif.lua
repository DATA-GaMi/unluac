...
<title>Mercurial Repository: p/unluac/hgcode: cc131a3e5839 test/src/nestedif.lua</title>
</head>
<body>
...
<li><a href="/p/unluac/hgcode/file/tip/test/src/nestedif.lua">latest</a></li>
<li><a href="/p/unluac/hgcode/diff/tip/test/src/nestedif.lua">diff</a></li>
<li><a href="/p/unluac/hgcode/comparison/tip/test/src/nestedif.lua">comparison</a></li>
<li><a href="/p/unluac/hgcode/annotate/tip/test/src/nestedif.lua">annotate</a></li>
<li><a href="/p/unluac/hgcode/log/tip/test/src/nestedif.lua">file log</a></li>
<li><a href="/p/unluac/hgcode/raw-file/tip/test/src/nestedif.lua">raw</a></li>
</ul>
<ul>
...
<h3>
 view test/src/nestedif.lua @ 503:<a href="/p/unluac/hgcode/rev/cc131a3e5839">cc131a3e5839</a>
...
<tr>
 ...
 <td class="author"><a href="/p/unluac/hgcode/file/741754f29ff3/test/src/nestedif.lua">741754f29ff3</a> </td>
</tr>
<tr>
...
<pre class="sourcelines stripes4 wrap bottomline"
     data-logurl="/p/unluac/hgcode/log/tip/test/src/nestedif.lua"
     data-selectabletag="SPAN"
     data-ishead="1">

<span id="l1">if x and y then</span><a href="#l1"></a>
<span id="l2">  f()</span><a href="#l2"></a>
<span id="l3">  if z then</span><a href="#l3"></a>
<span id="l4">    g()</span><a href="#l4"></a>
<span id="l5">  end</span><a href="#l5"></a>
<span id="l6">end</span><a href="#l6"></a>
<span id="l7">if x and y then</span><a href="#l7"></a>
<span id="l8">  if z then</span><a href="#l8"></a>
<span id="l9">    g()</span><a href="#l9"></a>
<span id="l10">  end</span><a href="#l10"></a>
<span id="l11">  f()</span><a href="#l11"></a>
<span id="l12">end</span><a href="#l12"></a>
<span id="l13">if x then</span><a href="#l13"></a>
<span id="l14">  f()</span><a href="#l14"></a>
<span id="l15">  if y then</span><a href="#l15"></a>
<span id="l16">    if z then</span><a href="#l16"></a>
<span id="l17">      g()</span><a href="#l17"></a>
<span id="l18">    end</span><a href="#l18"></a>
<span id="l19">    h()</span><a href="#l19"></a>
<span id="l20">  end</span><a href="#l20"></a>
